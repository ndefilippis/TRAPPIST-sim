...
def run_collision(bodies, t_max, dt, identifier, path, planet_patching = False, converter = None):
    ...
    for time_step in time_steps:
        ...
        file_name = os.path.join(dir_name, str("%03.8f" % time_step.number) + '.hdf5')
...
if __name__ == "__main__":
    ...
    for file in files: 
        ...
        for key in range(num_encounters):
            ...
            # the number of times we need to patch planets 
            ...
            for patch in range(num_patches):
                ...
                # the function above may return None...if it did, let's remove it
